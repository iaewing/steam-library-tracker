...
>
    ...
    >
        ...
        <column class="w-full gap-3">
            <native:pressable @navigate="route('mobile.test')" class="w-full items-center gap-3 rounded-lg border border-theme-outline bg-theme-surface-variant px-4 py-[14]"
            >
                <native:text class="flex-1 text-sm font-normal text-theme-on-surface">Test Native Route</native:text>
            </native:pressable>
            <row
                ref="docs-link"
